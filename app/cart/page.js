...
export default function CartPage() {
    return (
        <div class="p-4 bg-[#FAFAFA]">
            <div class="flex flex-col lg:flex-row md:my-6 px-6 ">
                ...
                <div class=" lg:w-1/3  p-6 h-full mt-6 border-2 border-[#D9D9D9] lg:mt-0 lg:ml-6">
                    ...
                    <div class="flex mb-4 gap-4 bg-white px-3">
                        ...
                        <div className="flex flex-col ml-4 mb-2 mt-3">
                    ...
                    <div class="flex justify-between text-lg font-semibold mt-2">
                        <span class="font-futuraPT font-normal text-xl ">Total</span>
                        <span class="font-futuraPT font-normal text-xm ">£1,031.00</span>
                    </div>
                    <div class="text-gray-600 text-sm mt-2 font-futuraPT text-[#AAAAAA]">Including £171.83 in taxes</div>
                </div>
            </div>
        </div >)
}