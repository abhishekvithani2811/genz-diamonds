            ...
            <div className="px-4 sm:px-6 lg:px-8 bg-white">
                <div className="flex flex-col sm:flex-row justify-between items-center px-2 py-2">
                    ...
                    <div class="relative inline-flex flex-col items-center mt-4 sm:mt-0">
                        ...
                        <button id="hs-dropdown-default" type="button" class="py-2 px-3 sm:py-3 sm:px-4 inline-flex items-center gap-x-1 sm:gap-x-2 text-xs sm:text-sm font-medium rounded-lg border border-[#C7C7CC] bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            Actions
