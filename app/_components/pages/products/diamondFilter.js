...
export default function DiamondFilter() {
    return (
        <>
            <div className="px-4 pb-4 sm:px-6 lg:px-8 bg-white">
                <div className="flex flex-col sm:flex-row justify-between items-center px-2 py-2">
                    ...
                    <div class="relative inline-flex flex-col items-center mt-4 sm:mt-0">
                        ...
                        <button id="hs-dropdown-default" type="button" class="py-2 px-3 sm:py-3 sm:px-4 inline-flex items-center gap-x-1 sm:gap-x-2 text-xs sm:text-sm font-medium border border-[#C7C7CC] bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            Actions
                            <svg class="transform transition-transform duration-300 rotate-0 group-hover:rotate-180 h-4 w-4 sm:h-6 sm:w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path d="m6 9 6 6 6-6" />
                            </svg>
                        </button>
                    </div>
