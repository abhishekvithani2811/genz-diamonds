    ...
    return (
      <>
        <div className="pr-6 mb-2 flex items-center space-x-2">
          ...
          <button className="sm:w-6 sm:h-6 w-5 h-5 -full border-2 border-gray-300 flex items-center justify-center">
            <span className="text-xs">PT</span>
          </button>
          <span className="w-3 h-3 sm:w-6  sm:h-6 -full bg-yellow-200"></span>
          <span className="w-3 h-3 sm:w-6  sm:h-6 -full bg-yellow-300"></span>
          <span className="w-3 h-3 sm:w-6 sm:h-6 -full bg-yellow-400"></span>
        </div>
      </>
    );
  };
