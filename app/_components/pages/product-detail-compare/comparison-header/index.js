        ...
        <div data-aos="fade-down" className="flex items-center justify-between p-4 gap-x-4 bg-gray-100 border-b border-dashed border-gray-300">
            <div className="flex items-center gap-x-2 relative w-fit">
                ...
                <input
                    ...
                    className="p-2 md:pl-9 block w-full bg-white border border-gray-300 -md focus:outline-none focus:ring-2 focus:ring-gray-300 xl:placeholder:text-base placeholder:text-sm md:placeholder:text-[#8E8E93] placeholder:text-transparent xl:w-fit w-10"
                />
            </div>
