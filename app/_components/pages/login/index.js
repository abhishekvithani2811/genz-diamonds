        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-160px)] bg-white sm:my-5">
            <div data-aos="fade-up" className="bg-white sm:px-10 sm:py-8 px-6 py-10 shadow-login max-w-[440px] w-full border border-[#F2F2F7]">
                ...
                <form>
                    ...
                    <Link href='/' type="submit" className="w-full md:py-3 py-3 px-4 bg-[#111111]/25 text-white font-semibold md:text-[20px] text-lg leading-[28.2px] cursor-pointer tracking-wider block text-center">Continue</Link>
                </form>
                ...
                <div>
                    <button className="w-full md:py-3 py-3 px-4 mb-4 flex items-center justify-center bg-white border border-gray-300 text-black font-medium md:text-[20px] text-lg leading-[28.2px] hover:bg-gray-50 tracking-normal">
                        <img src="https://www.google.com/favicon.ico" alt="Google" className="w-7 h-7 mr-2" />
                        Continue with Google
                    </button>
                    <button className="w-full md:py-3 py-3 mb-4 flex items-center justify-center bg-white border border-gray-300 text-black font-medium md:text-[20px] text-lg leading-[28.2px] hover:bg-gray-50 tracking-normal">
