        ...
        <div class="relative bg-cover grid lg:grid-cols-2 bg-center bg-[url('https://via.placeholder.com/1200x600')]">
            ...
            <div class="relative z-10 flex items-center justify-center h-full">
                <div class="text-white max-w-2xl lg:py-36 md:py-20 py-10 lg:px-0 px-4">
                    <h1 class="lg:text-4xl md:text-3xl text-2xl font-medium font-freight-medium">Forever Favorites Collection</h1>
                    <p class="mt-4 1xl:text-lg text-base font-futura-light lg:text-white">
